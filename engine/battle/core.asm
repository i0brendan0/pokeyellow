...
.gotTextToPrint
	...
	ld hl, wJumpKickDamageSave ; since the move missed, wDamage will always contain 0 at this point.
...
.chooseMove
	...
	add hl, de
	ld a, [hl]
	and $3f ; does the move have any PP left?
...
.moveMissed
	...
	ld a, [hli]
	ld [wJumpKickDamageSave], a
	ld a, [hld]
	ld [wJumpKickDamageSave + 1], a
	xor a
	ld [hli],a
	ld [hl],a
	inc a
